...
import vn.tdtu.finalterm.helper.factoryAndAdapter.service.ChiNhanhServiceFactory;
...
//        return chiNhanhServiceFactory.insertChiNhanh(chiNhanh, request);
//    }
//    @PostMapping("/chiNhanhByTK")
//    public ResponseEntity<ResponseObject> findChiNhanhByTaiKhoan(@Valid @RequestBody TaiKhoan taiKhoan) {
//        return chiNhanhServiceFactory.findChiNhanhByTaiKhoan(taiKhoan);
//    }
...
//        return chiNhanhServiceFactory.updateChiNhanh(chiNhanh, id);
//    }
//    @DeleteMapping("/chiNhanh/{id}")
//    public ResponseEntity<ResponseObject> deleteChiNhanh(@PathVariable("id") Long id) {
//        return chiNhanhServiceFactory.deleteChiNhanh(id);
//    }
