...
public class ChiTietHDService {
    ...
    public ResponseEntity<ResponseObject> insertChiTietHDAndHD(TaoHoaDonDTO taoHoaDonDTO) {
        ...
        ResponseEntity<ResponseObject> checkQuantity = quanLySPServiceObserver.deleteQuantityQuanLySP(taoHoaDonDTO.getSanPhamId(), taoHoaDonDTO.getChiNhanhId(), taoHoaDonDTO.getChiTietHoaDon());
    ...
    public ResponseEntity<ResponseObject> updateChiTietHD(ChiTietHoaDon chiTietHoaDon, Long chiTietHDId) {
        ...
        ResponseEntity<ResponseObject> checkQuantity = quanLySPServiceObserver.deleteQuantityQuanLySP(new Long[]{foundCTHD.get().getSanPham().getId()}, foundCTHD.get().getChiNhanh().getId(), new ChiTietHoaDon[]{objCTHD});
        if(checkQuantity != null) {
            return checkQuantity;
        }
