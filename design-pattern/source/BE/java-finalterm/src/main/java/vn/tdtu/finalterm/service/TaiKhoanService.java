...
import vn.tdtu.finalterm.helper.command.Command;
...
public class TaiKhoanService {
    ...
    // Command
    private final Command enableAccountCommand;

    @Autowired
    public TaiKhoanService(Command enableAccountCommand) {
        this.enableAccountCommand = enableAccountCommand;
    }

    // TEST COMMAND PATTERN
    public void enableAccount(String taiKhoanId) {
        if (taiKhoanId == null) {
            throw new IllegalArgumentException("taiKhoanId cannot be null");
        }

        if (enableAccountCommand == null) {
            throw new IllegalStateException("enableAccountCommand is not initialized");
        }

        enableAccountCommand.execute();
    }
